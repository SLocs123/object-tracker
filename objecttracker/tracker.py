...
class Tracker:
    ...
    def get(self, det_array: np.ndarray, input_image: np.ndarray) -> tuple[np.ndarray, int]: # NEW 
        ...
        inference_start = time.monotonic_ns() # NEW
        ...
        return (tracking_output_array, inference_time_us)
